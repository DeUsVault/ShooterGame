...
echo.
echo Clearing Plugin Intermediate
echo.
...
"D:\Program Files (x86)\Epic Games\Launcher\Engine\Binaries\Win64\UnrealVersionSelector.exe" /projectfiles "%~dp0\%projectName%.uproject"