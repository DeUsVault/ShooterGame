...
namespace // The Keyword for Custom Matches
{
	const FString CustomMatchKeyword("Custom");
}

AShooterGameSession::AShooterGameSession()
{
...
void AShooterGameSession::InitOptions(const FString& Options)
{
	check(GetWorld());
	...
	if (GameMode)
	{
		UClass* PlayerStateClass = UShooterGameData::Get().PlayerStateClass.LoadSynchronous(); // @TODO: Load Async
